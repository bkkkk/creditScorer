...
upSampled <- upSample(x = select(imputed_tr, -seriousDlqin), y = imputed_tr$seriousDlqin)
upSampledPredictors <- as.matrix(select(upSampled, -Class))
upSampledResponse <- upSampled$Class
