...
```{r}
caret::getTrainPerf(model_fixed)
```

As can be seen the rebalanced classes result in much better identification of the cases where borrowers defaulted on their payments. Identification of the "success" cases has decreased somewhat however now the cases of interest are identified correctly.
